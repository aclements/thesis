...
\XXX[STATUS]{Expanded and reworked to focus on conflict-freedom up to
  3.4.
%  Planning to add non-commutative non-scalability rule and discussion
%  of global clocks.
  Applied: Eddie init-244-ga695479 up to 3.4.
  Unapplied: Eddie init-244-ga695479 3.4 and on.
}
...
\Thiscref{sec:rule} forms the first of two steps toward the scalable
commutativity rule.  The following \lcnamecref{sec:scalability}
completes the rule by showing that, under reasonable assumptions about
modern multicore hardware, conflict-free implementations scale.
...
\XXX![AC]{Still editing past here.}
\subsection{Rule}
