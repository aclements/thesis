...
\node[pass, name=ana, right of=beg, xshift=4em] {\analyzer{} \\ (\S\ref{sec:model:analyzer})};
\node[pass, name=gen, right of=ana, xshift=11em] {\generator{} \\ (\S\ref{sec:model:generator})};
\node[pass, name=mtr, right of=gen, xshift=10em] {\mtrace{} \\ (\S\ref{sec:model:mtrace})};
