...
%
\Thiscref{sec:scalability} looks at the machine: it shows that, under
...
formally about in the following \lcnamecref{sec:rule}.  Together, the
empirical result of \thiscref{sec:scalability} and the formal result
of the next \lcnamecref{sec:rule} form the scalable commutativity
rule.
