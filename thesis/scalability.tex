...
\XXX[STATUS]{Draft ready.  New chapter.  Have un-applied edits from
  Frans.}
...
\XXX[AC]{If this chapter winds up after the rule chapter, conclude by
  saying that we now have the rule in its full, pragmatic form.}
