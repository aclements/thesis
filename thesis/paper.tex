...
% The changebar package is remarkably insidious.  You may need to
% delete your .aux file after switch to non-draft mode to remove all
% of its leftovers and get the paper to build.
\let\cbstart=\relax
\let\cbend=\relax
\usepackage{alltt}
\usepackage{mathrsfs}
...
\newcommand{\generator}{{\scshape Testgen}\xspace}
\newcommand{\mtrace}{{\scshape Mtrace}\xspace}
\newcommand{\SRI}{SIM\xspace}
