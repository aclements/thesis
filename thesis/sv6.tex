...
\XXX[STATUS]{Draft v2 ready (have unapplied edits from Eddie).  Split
  ...
  all subsections.  Applied: Frans init-154-6dbae76 (with one
  outstanding bigger change to \fs section), small edits from Eddie
  init-244-ga695479 (not the bigger restructuring).}
