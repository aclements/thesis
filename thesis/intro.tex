...
\XXX[STATUS]{Draft v2 ready.  Restructured contributions and outline
  from draft v1.  Re-organized and expanded from SOSP.  Applied: Frans
  init-176-g5ef5d9a, Eddie init-244-ga695479.}
...
%
\XXX[AC]{Incorporate clock/heat/cores plot from defense?}
...
conflict-free during those operations---meaning no core
...
However, real-world interfaces and their implementations are complex.
